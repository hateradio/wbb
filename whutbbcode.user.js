...
// @exclude        http*://*secret-cinema.pw/user.php?action=notify*
// @exclude        http*://*secret-cinema.pw/tools.php?action=clear_cache*
 ...
 * Updates
 * 4.9.4
 *   adds support for secret-cinema.pw
 *
 * 4.9.3
...
(function () {
	...
	WhutBB.db = {
		sites: {
			...
			tehconnection: function () {
				return {
					emoticonDir: 'https://tehconnection.eu/static/common/smileys/',
					emoticons: 'gazelle',
					blueprint: 'gazelle'
				};
			},
			...
			morethan: function () {
				return {
					emoticonDir: 'https://morethan.tv/static/common/smileys/',
					emoticons: 'gazelle',
					blueprint: 'gazelle'
				};
			},
			alpharatio: function () {
				return {
					emoticonDir: 'https://alpharatio.cc/static/common/smileys/',
					emoticons: 'gazelle',
					blueprint: 'gazelle'
				};
			},
