...
// @screenshot     https://i.sli.mg/YYzYQI.png
...
// @include        http*://*nostre.am/wiki.php*
// @exclude        http*://*nostre.am/*logchecker*
// @exclude        http*://*nostre.am/user.php?action=notify*
// @exclude        http*://*nostre.am/reportsv2.php*
		...
		sites: {
			...
			brainwashthemasses: function () {
				return {
					...
					emoticons: WhutBB.db.emoticons.gazelle.concat(WhutBB.db.emoticons.brainwashthemasses),
					blueprint: 'gazelle'
				};
			},
			...
			nostream: function () {
				return {
					emoticonDir: '/static/common/smileys/',
					emoticons: WhutBB.db.emoticons.gazelle.concat(WhutBB.db.emoticons.nostream),
					blueprint: 'gazelle'
				};
			},
			...
			hz: function () {
				return {
					emoticonDir: 'https://hydra.zone/static/common/smileys/',
					emoticons: 'gazelle',
					blueprint: 'gazelle'
				};
			},
